module github.com/albertocavalcante/bz/tools
...
// Use the local checkout so go mod tidy doesn't try to fetch the
// private parent module over the network.
replace github.com/albertocavalcante/bz => ./

require (
	github.com/BurntSushi/toml v1.6.0
	github.com/albertocavalcante/bz v0.0.0-20260205142226-279315831e59
	github.com/albertocavalcante/go-bcr v0.0.0-20260204171121-c5dcf4fa037f
	github.com/albertocavalcante/go-bzlmod v0.0.0-20260206181514-5436f642d01f
