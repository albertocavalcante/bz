...
- [Complete Security Pipeline](#complete-security-pipeline)
...
**Note:** License information comes from the registry's `source.json` files. If a module shows "Unknown", the registry may not have license metadata for that version.
